...
import tmttyped.std.stdStrings.all
import tmttyped.std.stdStrings.copy
import tmttyped.std.stdStrings.copyLink
import tmttyped.std.stdStrings.copyMove
import tmttyped.std.stdStrings.link
import tmttyped.std.stdStrings.linkMove
import tmttyped.std.stdStrings.move
import tmttyped.std.stdStrings.none
import tmttyped.std.stdStrings.uninitialized
