...
object EXTColorBufferHalfFloat {
  ...
  implicit class EXTColorBufferHalfFloatMutableBuilder[Self <: EXTColorBufferHalfFloat] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRGB16F_EXT(value: GLenum): Self = StObject.set(x, "RGB16F_EXT", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRGBA16F_EXT(value: GLenum): Self = StObject.set(x, "RGBA16F_EXT", value.asInstanceOf[js.Any])
