...
object SVGPathSegArcAbs {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegArcAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegArcAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegArcAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegArcAbs] (val x: Self) extends AnyVal {
