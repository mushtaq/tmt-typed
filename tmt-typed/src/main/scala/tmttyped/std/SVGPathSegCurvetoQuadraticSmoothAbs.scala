...
object SVGPathSegCurvetoQuadraticSmoothAbs {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticSmoothAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticSmoothAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoQuadraticSmoothAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoQuadraticSmoothAbs] (val x: Self) extends AnyVal {
