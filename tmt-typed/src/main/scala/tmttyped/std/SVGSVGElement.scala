...
import tmttyped.std.stdStrings.SVGUnload
import tmttyped.std.stdStrings.SVGZoom
...
trait SVGSVGElement
  ...
  var onunload: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.raw.Event, js.Any]) | Null = js.native
