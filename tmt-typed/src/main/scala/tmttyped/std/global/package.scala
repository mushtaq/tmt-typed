...
import tmttyped.std.BigIntConstructor
...
import tmttyped.std.IdleRequestCallback
import tmttyped.std.IdleRequestOptions
import tmttyped.std.ImageBitmapOptions
import tmttyped.std.ImageBitmapSource
...
import tmttyped.std.OnErrorEventHandler
import tmttyped.std.PromiseConstructor
import tmttyped.std.ProxyConstructor
...
import tmttyped.std.ScrollToOptions
import tmttyped.std.SetConstructor
import tmttyped.std.SharedArrayBufferConstructor
import tmttyped.std.SpeechSynthesis
import tmttyped.std.StringConstructor
import tmttyped.std.StructuredSerializeOptions
import tmttyped.std.SymbolConstructor
import tmttyped.std.SyntaxErrorConstructor
import tmttyped.std.TimerHandler
import tmttyped.std.Transferable
...
import tmttyped.std.stdStrings.beforeprint
import tmttyped.std.stdStrings.beforeunload
...
import tmttyped.std.stdStrings.hashchange
...
import tmttyped.std.stdStrings.languagechange
...
import tmttyped.std.stdStrings.offline
import tmttyped.std.stdStrings.online
import tmttyped.std.stdStrings.orientationchange
import tmttyped.std.stdStrings.pagehide
import tmttyped.std.stdStrings.pageshow
...
import tmttyped.std.stdStrings.popstate
import tmttyped.std.stdStrings.progress
import tmttyped.std.stdStrings.ratechange
import tmttyped.std.stdStrings.rejectionhandled
...
import tmttyped.std.stdStrings.storage
...
import tmttyped.std.stdStrings.unhandledrejection
import tmttyped.std.stdStrings.unload
...
inline def ActiveXObject: tmttyped.std.ActiveXObject = js.Dynamic.global.selectDynamic("ActiveXObject").asInstanceOf[tmttyped.std.ActiveXObject]
inline def ActiveXObject_=(x: tmttyped.std.ActiveXObject): Unit = js.Dynamic.global.updateDynamic("ActiveXObject")(x.asInstanceOf[js.Any])
...
inline def Atomics: tmttyped.std.Atomics = js.Dynamic.global.selectDynamic("Atomics").asInstanceOf[tmttyped.std.Atomics]
inline def Atomics_=(x: tmttyped.std.Atomics): Unit = js.Dynamic.global.updateDynamic("Atomics")(x.asInstanceOf[js.Any])
...
/**
  ...
  */
inline def JSON: tmttyped.std.JSON = js.Dynamic.global.selectDynamic("JSON").asInstanceOf[tmttyped.std.JSON]
inline def JSON_=(x: tmttyped.std.JSON): Unit = js.Dynamic.global.updateDynamic("JSON")(x.asInstanceOf[js.Any])

inline def Map_=(x: MapConstructor): Unit = js.Dynamic.global.updateDynamic("Map")(x.asInstanceOf[js.Any])

/** An intrinsic object that provides basic mathematics functionality and constants. */
inline def Math: tmttyped.std.Math = js.Dynamic.global.selectDynamic("Math").asInstanceOf[tmttyped.std.Math]
inline def Math_=(x: tmttyped.std.Math): Unit = js.Dynamic.global.updateDynamic("Math")(x.asInstanceOf[js.Any])
...
inline def addEventListener_beforeinput(
  `type`: beforeinput,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.InputEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_beforeinput(
  `type`: beforeinput,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.InputEvent, Any],
...
inline def addEventListener_formdata(
  `type`: formdata,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.FormDataEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_formdata(
  `type`: formdata,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.FormDataEvent, Any],
...
inline def addEventListener_pagehide(
  `type`: pagehide,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_pagehide(
  `type`: pagehide,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any],
...
inline def addEventListener_rejectionhandled(
  ...
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_rejectionhandled(
  `type`: rejectionhandled,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any],
...
inline def addEventListener_securitypolicyviolation(
  ...
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SecurityPolicyViolationEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_securitypolicyviolation(
  `type`: securitypolicyviolation,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SecurityPolicyViolationEvent, Any],
...
inline def addEventListener_submit(
  `type`: submit,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SubmitEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_submit(
  `type`: submit,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SubmitEvent, Any],
...
inline def createImageBitmap(image: ImageBitmapSource): js.Promise[tmttyped.std.ImageBitmap] = js.Dynamic.global.applyDynamic("createImageBitmap")(image.asInstanceOf[js.Any]).asInstanceOf[js.Promise[tmttyped.std.ImageBitmap]]
inline def createImageBitmap(image: ImageBitmapSource, options: ImageBitmapOptions): js.Promise[tmttyped.std.ImageBitmap] = (js.Dynamic.global.applyDynamic("createImageBitmap")(image.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[tmttyped.std.ImageBitmap]]
inline def createImageBitmap(image: ImageBitmapSource, sx: Double, sy: Double, sw: Double, sh: Double): js.Promise[tmttyped.std.ImageBitmap] = (js.Dynamic.global.applyDynamic("createImageBitmap")(image.asInstanceOf[js.Any], sx.asInstanceOf[js.Any], sy.asInstanceOf[js.Any], sw.asInstanceOf[js.Any], sh.asInstanceOf[js.Any])).asInstanceOf[js.Promise[tmttyped.std.ImageBitmap]]
...
inline def customElements: tmttyped.std.CustomElementRegistry = js.Dynamic.global.selectDynamic("customElements").asInstanceOf[tmttyped.std.CustomElementRegistry]
inline def customElements_=(x: tmttyped.std.CustomElementRegistry): Unit = js.Dynamic.global.updateDynamic("customElements")(x.asInstanceOf[js.Any])
...
inline def locationbar: tmttyped.std.BarProp = js.Dynamic.global.selectDynamic("locationbar").asInstanceOf[tmttyped.std.BarProp]
inline def locationbar_=(x: tmttyped.std.BarProp): Unit = js.Dynamic.global.updateDynamic("locationbar")(x.asInstanceOf[js.Any])
...
inline def menubar: tmttyped.std.BarProp = js.Dynamic.global.selectDynamic("menubar").asInstanceOf[tmttyped.std.BarProp]
inline def menubar_=(x: tmttyped.std.BarProp): Unit = js.Dynamic.global.updateDynamic("menubar")(x.asInstanceOf[js.Any])
...
inline def onformdata: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.FormDataEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onformdata").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.FormDataEvent, Any]) | Null]
inline def onformdata_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.FormDataEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onformdata")(x.asInstanceOf[js.Any])
...
inline def onpagehide: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onpagehide").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]) | Null]
inline def onpagehide_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onpagehide")(x.asInstanceOf[js.Any])

inline def onpageshow: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onpageshow").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]) | Null]
inline def onpageshow_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PageTransitionEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onpageshow")(x.asInstanceOf[js.Any])
...
inline def onrejectionhandled: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onrejectionhandled").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]) | Null]
inline def onrejectionhandled_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onrejectionhandled")(x.asInstanceOf[js.Any])
...
inline def onsecuritypolicyviolation: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SecurityPolicyViolationEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onsecuritypolicyviolation").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SecurityPolicyViolationEvent, Any]) | Null]
inline def onsecuritypolicyviolation_=(
  x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SecurityPolicyViolationEvent, Any]) | Null
...
inline def onsubmit: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SubmitEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onsubmit").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SubmitEvent, Any]) | Null]
inline def onsubmit_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.SubmitEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onsubmit")(x.asInstanceOf[js.Any])
...
inline def onunhandledrejection: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onunhandledrejection").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]) | Null]
inline def onunhandledrejection_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ tmttyped.std.PromiseRejectionEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onunhandledrejection")(x.asInstanceOf[js.Any])
...
inline def personalbar: tmttyped.std.BarProp = js.Dynamic.global.selectDynamic("personalbar").asInstanceOf[tmttyped.std.BarProp]
inline def personalbar_=(x: tmttyped.std.BarProp): Unit = js.Dynamic.global.updateDynamic("personalbar")(x.asInstanceOf[js.Any])
...
inline def scrollbars: tmttyped.std.BarProp = js.Dynamic.global.selectDynamic("scrollbars").asInstanceOf[tmttyped.std.BarProp]
inline def scrollbars_=(x: tmttyped.std.BarProp): Unit = js.Dynamic.global.updateDynamic("scrollbars")(x.asInstanceOf[js.Any])
...
inline def statusbar: tmttyped.std.BarProp = js.Dynamic.global.selectDynamic("statusbar").asInstanceOf[tmttyped.std.BarProp]
inline def statusbar_=(x: tmttyped.std.BarProp): Unit = js.Dynamic.global.updateDynamic("statusbar")(x.asInstanceOf[js.Any])
...
inline def toolbar: tmttyped.std.BarProp = js.Dynamic.global.selectDynamic("toolbar").asInstanceOf[tmttyped.std.BarProp]
inline def toolbar_=(x: tmttyped.std.BarProp): Unit = js.Dynamic.global.updateDynamic("toolbar")(x.asInstanceOf[js.Any])
