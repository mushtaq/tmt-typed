...
/* Rewritten from type alias, can be one of: 
  - tmttyped.std.stdStrings.allpass
  - tmttyped.std.stdStrings.bandpass
  - tmttyped.std.stdStrings.highpass
  - tmttyped.std.stdStrings.highshelf
  - tmttyped.std.stdStrings.lowpass
  - tmttyped.std.stdStrings.lowshelf
  - tmttyped.std.stdStrings.notch
  - tmttyped.std.stdStrings.peaking
*/
