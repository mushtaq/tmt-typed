...
trait Uint8ClampedArray extends /* index */ NumberDictionary[Double] {
  ...
  def slice(start: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Uint8ClampedArray = js.native
  ...
  def subarray(begin: js.UndefOr[scala.Nothing], end: Double): js.typedarray.Uint8ClampedArray = js.native
  ...
  val toStringTag: tmttyped.std.stdStrings.Uint8ClampedArray = js.native
