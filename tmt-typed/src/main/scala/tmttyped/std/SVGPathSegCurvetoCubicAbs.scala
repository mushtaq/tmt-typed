...
object SVGPathSegCurvetoCubicAbs {
  ...
  def apply(
    ...
    y1: Double,
    y2: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoCubicAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoCubicAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoCubicAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoCubicAbs] (val x: Self) extends AnyVal {
