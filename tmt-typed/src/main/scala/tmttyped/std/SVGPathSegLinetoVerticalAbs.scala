...
object SVGPathSegLinetoVerticalAbs {
  ...
  def apply(
    ...
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegLinetoVerticalAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegLinetoVerticalAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegLinetoVerticalAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegLinetoVerticalAbs] (val x: Self) extends AnyVal {
