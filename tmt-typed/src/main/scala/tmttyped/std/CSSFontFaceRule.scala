...
object CSSFontFaceRule {
  ...
  def apply(
    ...
    `type`: Double
  ): org.scalajs.dom.raw.CSSFontFaceRule = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.CSSFontFaceRule]
  }
  
  @scala.inline
  implicit class CSSFontFaceRuleMutableBuilder[Self <: org.scalajs.dom.raw.CSSFontFaceRule] (val x: Self) extends AnyVal {
