...
object RTCIceCandidatePair {
  ...
  implicit class RTCIceCandidatePairMutableBuilder[Self <: RTCIceCandidatePair] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocal(value: org.scalajs.dom.experimental.webrtc.RTCIceCandidate): Self = StObject.set(x, "local", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLocalUndefined: Self = StObject.set(x, "local", js.undefined)
    
    @scala.inline
    def setRemote(value: org.scalajs.dom.experimental.webrtc.RTCIceCandidate): Self = StObject.set(x, "remote", value.asInstanceOf[js.Any])
