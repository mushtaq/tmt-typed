...
object SVGPathSegCurvetoCubicSmoothAbs {
  ...
  def apply(
    ...
    y: Double,
    y2: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoCubicSmoothAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoCubicSmoothAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoCubicSmoothAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoCubicSmoothAbs] (val x: Self) extends AnyVal {
