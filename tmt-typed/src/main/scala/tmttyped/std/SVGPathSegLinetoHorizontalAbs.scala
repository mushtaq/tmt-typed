...
object SVGPathSegLinetoHorizontalAbs {
  ...
  def apply(
    ...
    x: Double
  ): org.scalajs.dom.raw.SVGPathSegLinetoHorizontalAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegLinetoHorizontalAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegLinetoHorizontalAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegLinetoHorizontalAbs] (val x: Self) extends AnyVal {
