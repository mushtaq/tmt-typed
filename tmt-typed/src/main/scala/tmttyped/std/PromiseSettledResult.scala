...
object PromiseSettledResult {
  ...
  inline def PromiseFulfilledResult[T](value: T): tmttyped.std.PromiseFulfilledResult[T] = {
  ...
  inline def PromiseRejectedResult(reason: Any): tmttyped.std.PromiseRejectedResult = {
