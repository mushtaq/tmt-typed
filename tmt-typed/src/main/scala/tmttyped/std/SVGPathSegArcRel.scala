...
object SVGPathSegArcRel {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegArcRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegArcRel]
  }
  
  @scala.inline
  implicit class SVGPathSegArcRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegArcRel] (val x: Self) extends AnyVal {
