...
trait ObjectConstructor
  ...
  /**
    ...
    */
  @JSName("fromEntries")
  def fromEntries_T_StringDictionary[T](entries: js.Iterable[js.Tuple2[PropertyKey, T]]): StringDictionary[T] = js.native
  ...
  /**
    ...
    * @param o Object that contains the properties and methods. This can be an object that you created or an existing Document Object Model (DOM) object.
    */
  def getOwnPropertyDescriptors[T](o: T): tmttyped.std.stdStrings.ObjectConstructor with TopLevel[T] with StringDictionary[js.PropertyDescriptor] = js.native
