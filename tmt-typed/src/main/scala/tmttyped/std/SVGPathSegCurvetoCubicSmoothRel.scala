...
object SVGPathSegCurvetoCubicSmoothRel {
  ...
  def apply(
    ...
    y: Double,
    y2: Double
  ): org.scalajs.dom.raw.SVGPathSegCurvetoCubicSmoothRel = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegCurvetoCubicSmoothRel]
  }
  
  @scala.inline
  implicit class SVGPathSegCurvetoCubicSmoothRelMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegCurvetoCubicSmoothRel] (val x: Self) extends AnyVal {
