...
trait HTMLElementTagNameMap extends StObject {
  ...
  var caption: org.scalajs.dom.raw.HTMLTableCaptionElement
...
object HTMLElementTagNameMap {
  ...
  def apply(
    ...
    caption: org.scalajs.dom.raw.HTMLTableCaptionElement,
  ...
  implicit class HTMLElementTagNameMapMutableBuilder[Self <: HTMLElementTagNameMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCaption(value: org.scalajs.dom.raw.HTMLTableCaptionElement): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMenu(value: org.scalajs.dom.raw.HTMLMenuElement): Self = StObject.set(x, "menu", value.asInstanceOf[js.Any])
