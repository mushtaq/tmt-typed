...
object SVGPathSegLinetoAbs {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): org.scalajs.dom.raw.SVGPathSegLinetoAbs = {
    ...
    __obj.asInstanceOf[org.scalajs.dom.raw.SVGPathSegLinetoAbs]
  }
  
  @scala.inline
  implicit class SVGPathSegLinetoAbsMutableBuilder[Self <: org.scalajs.dom.raw.SVGPathSegLinetoAbs] (val x: Self) extends AnyVal {
