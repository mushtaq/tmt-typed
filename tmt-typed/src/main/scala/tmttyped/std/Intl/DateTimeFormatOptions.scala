...
import tmttyped.std.stdStrings.longGeneric
import tmttyped.std.stdStrings.longOffset
...
import tmttyped.std.stdStrings.shortGeneric
import tmttyped.std.stdStrings.shortOffset
