...
/* Rewritten from type alias, can be one of: 
  - tmttyped.std.stdStrings.zero
  - tmttyped.std.stdStrings.one
  - tmttyped.std.stdStrings.two
  - tmttyped.std.stdStrings.few
  - tmttyped.std.stdStrings.many
  - tmttyped.std.stdStrings.other
*/
