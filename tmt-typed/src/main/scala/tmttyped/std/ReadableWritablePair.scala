...
trait ReadableWritablePair[R, W] extends StObject {
  ...
  var readable: org.scalajs.dom.experimental.ReadableStream[R]
...
object ReadableWritablePair {
  ...
  @scala.inline
  def apply[R, W](readable: org.scalajs.dom.experimental.ReadableStream[R], writable: WritableStream[W]): ReadableWritablePair[R, W] = {
  ...
  implicit class ReadableWritablePairMutableBuilder[Self <: ReadableWritablePair[_, _], R, W] (val x: Self with (ReadableWritablePair[R, W])) extends AnyVal {
    ...
    @scala.inline
    def setReadable(value: org.scalajs.dom.experimental.ReadableStream[R]): Self = StObject.set(x, "readable", value.asInstanceOf[js.Any])
