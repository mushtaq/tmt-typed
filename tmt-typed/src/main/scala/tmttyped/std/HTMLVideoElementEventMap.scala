...
object HTMLVideoElementEventMap {
  ...
  @scala.inline
  implicit class HTMLVideoElementEventMapMutableBuilder[Self <: HTMLVideoElementEventMap] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setEnterpictureinpicture(value: org.scalajs.dom.Event): Self = StObject.set(x, "enterpictureinpicture", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeavepictureinpicture(value: org.scalajs.dom.Event): Self = StObject.set(x, "leavepictureinpicture", value.asInstanceOf[js.Any])
  }
}
