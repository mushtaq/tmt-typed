...
import tmttyped.node.childProcessMod.IOType
import tmttyped.node.childProcessMod.SerializationType
import tmttyped.node.childProcessMod.StdioNull
import tmttyped.node.childProcessMod.StdioPipeNamed
import tmttyped.node.cryptoMod.BinaryToTextEncoding
import tmttyped.node.cryptoMod.CharacterEncoding
import tmttyped.node.cryptoMod.CipherCCMTypes
import tmttyped.node.cryptoMod.CipherGCMTypes
import tmttyped.node.cryptoMod.CipherMode
import tmttyped.node.cryptoMod.CipherOCBTypes
import tmttyped.node.cryptoMod.DSAEncoding
import tmttyped.node.cryptoMod.ECDHKeyFormat
import tmttyped.node.cryptoMod.Encoding
import tmttyped.node.cryptoMod.KeyFormat
import tmttyped.node.cryptoMod.KeyObjectType
import tmttyped.node.cryptoMod.KeyType
import tmttyped.node.cryptoMod.LegacyCharacterEncoding
import tmttyped.node.cryptoMod.webcrypto.KeyUsage
...
import tmttyped.node.netMod.SocketReadyState
import tmttyped.node.perfHooksMod.EntryType
import tmttyped.node.processMod.global.NodeJS.Architecture
...
object nodeStrings {
  ...
  sealed trait jwk
    extends StObject
       with tmttyped.node.cryptoMod.webcrypto.KeyFormat
  ...
  sealed trait `private`
    extends StObject
       with KeyObjectType
       with tmttyped.node.cryptoMod.webcrypto.KeyType
