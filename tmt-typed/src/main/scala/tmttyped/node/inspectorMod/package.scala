...
package object inspectorMod {
  ...
  @scala.inline
  def open(port: js.UndefOr[scala.Nothing], host: js.UndefOr[scala.Nothing], wait: scala.Boolean): scala.Unit = (tmttyped.node.inspectorMod.^.asInstanceOf[js.Dynamic].applyDynamic("open")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], wait.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def open(port: js.UndefOr[scala.Nothing], host: java.lang.String): scala.Unit = (tmttyped.node.inspectorMod.^.asInstanceOf[js.Dynamic].applyDynamic("open")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def open(port: js.UndefOr[scala.Nothing], host: java.lang.String, wait: scala.Boolean): scala.Unit = (tmttyped.node.inspectorMod.^.asInstanceOf[js.Dynamic].applyDynamic("open")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], wait.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  ...
  @scala.inline
  def open(port: scala.Double, host: js.UndefOr[scala.Nothing], wait: scala.Boolean): scala.Unit = (tmttyped.node.inspectorMod.^.asInstanceOf[js.Dynamic].applyDynamic("open")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], wait.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
