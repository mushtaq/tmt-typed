...
import tmttyped.node.nodeStrings.altsvc
import tmttyped.node.nodeStrings.origin
...
trait ClientHttp2Session extends StObject {
  ...
  @JSName("emit")
  def emit_connect(event: tmttyped.node.nodeStrings.connect, session: ClientHttp2Session, socket: Socket): Boolean = js.native
  @JSName("emit")
  def emit_connect(event: tmttyped.node.nodeStrings.connect, session: ClientHttp2Session, socket: TLSSocket): Boolean = js.native
  @JSName("emit")
