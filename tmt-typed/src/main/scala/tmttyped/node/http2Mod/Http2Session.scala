...
import tmttyped.node.nodeStrings.goaway
import tmttyped.node.nodeStrings.ping
...
trait Http2Session
  ...
  def addListener_localSettings(
    event: tmttyped.node.nodeStrings.localSettings,
  ...
  def addListener_remoteSettings(
    event: tmttyped.node.nodeStrings.remoteSettings,
    listener: js.Function1[/* settings */ Settings, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_localSettings(event: tmttyped.node.nodeStrings.localSettings, settings: Settings): Boolean = js.native
  @JSName("emit")
  def emit_ping(event: ping): Boolean = js.native
  @JSName("emit")
  def emit_remoteSettings(event: tmttyped.node.nodeStrings.remoteSettings, settings: Settings): Boolean = js.native
  @JSName("emit")
