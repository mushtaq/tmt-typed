...
object ReadableStreamDefaultReadResult {
  ...
  inline def ReadableStreamDefaultReadDoneResult(value: Unit): tmttyped.node.streamWebMod.ReadableStreamDefaultReadDoneResult = {
    val __obj = js.Dynamic.literal(done = true, value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[tmttyped.node.streamWebMod.ReadableStreamDefaultReadDoneResult]
  }
  
  inline def ReadableStreamDefaultReadValueResult[T](value: T): tmttyped.node.streamWebMod.ReadableStreamDefaultReadValueResult[T] = {
