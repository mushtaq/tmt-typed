...
object promises {
  ...
  @scala.inline
  def futimes(handle: FileHandle, atime: String, mtime: js.Date): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("futimes")(handle.asInstanceOf[js.Any], atime.asInstanceOf[js.Any], mtime.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  @scala.inline
  ...
  @scala.inline
  def futimes(handle: FileHandle, atime: js.Date, mtime: String): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("futimes")(handle.asInstanceOf[js.Any], atime.asInstanceOf[js.Any], mtime.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  @scala.inline
  ...
  @scala.inline
  def lstat(path: PathLike, opts: StatOptionsbiginttrue): js.Promise[tmttyped.node.nodeFsMod.BigIntStats] = (^.asInstanceOf[js.Dynamic].applyDynamic("lstat")(path.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[tmttyped.node.nodeFsMod.BigIntStats]]
  @scala.inline
  def lstat(path: PathLike, opts: StatOptions): js.Promise[tmttyped.node.nodeFsMod.Stats | tmttyped.node.nodeFsMod.BigIntStats] = (^.asInstanceOf[js.Dynamic].applyDynamic("lstat")(path.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[tmttyped.node.nodeFsMod.Stats | tmttyped.node.nodeFsMod.BigIntStats]]
  ...
  /**
    ...
    */
  @scala.inline
  def readdir(path: PathLike, options: BaseEncodingOptionswithFiEncoding): js.Promise[js.Array[tmttyped.node.nodeFsMod.Dirent]] = (^.asInstanceOf[js.Dynamic].applyDynamic("readdir")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[tmttyped.node.nodeFsMod.Dirent]]]
  /**
    * Asynchronous readdir(3) - read a directory.
    * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
  ...
  @scala.inline
  def stat(path: PathLike, opts: StatOptionsbiginttrue): js.Promise[tmttyped.node.nodeFsMod.BigIntStats] = (^.asInstanceOf[js.Dynamic].applyDynamic("stat")(path.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[tmttyped.node.nodeFsMod.BigIntStats]]
  @scala.inline
  def stat(path: PathLike, opts: StatOptions): js.Promise[tmttyped.node.nodeFsMod.Stats | tmttyped.node.nodeFsMod.BigIntStats] = (^.asInstanceOf[js.Dynamic].applyDynamic("stat")(path.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[tmttyped.node.nodeFsMod.Stats | tmttyped.node.nodeFsMod.BigIntStats]]
