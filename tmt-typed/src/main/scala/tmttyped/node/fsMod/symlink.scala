...
object symlink {
  ...
  */
  ...
  object Type {
    ...
    inline def dir: tmttyped.node.nodeStrings.dir = "dir".asInstanceOf[tmttyped.node.nodeStrings.dir]
    
    inline def file: tmttyped.node.nodeStrings.file = "file".asInstanceOf[tmttyped.node.nodeStrings.file]
    
    inline def junction: tmttyped.node.nodeStrings.junction = "junction".asInstanceOf[tmttyped.node.nodeStrings.junction]
  }
}
