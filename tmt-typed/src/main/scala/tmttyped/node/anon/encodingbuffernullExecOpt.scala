...
trait encodingbuffernullExecOpt extends StObject {
  ...
  var cwd: js.UndefOr[String | tmttyped.node.nodeUrlMod.URL] = js.undefined
...
object encodingbuffernullExecOpt {
  ...
  extension [Self <: encodingbuffernullExecOpt](x: Self) {
    ...
    inline def setCwd(value: String | tmttyped.node.nodeUrlMod.URL): Self = StObject.set(x, "cwd", value.asInstanceOf[js.Any])
