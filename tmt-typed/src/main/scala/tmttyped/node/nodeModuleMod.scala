...
object nodeModuleMod extends Shortcut {
  ...
  /**
    ...
    * @since v13.7.0, v12.17.0
    */
  inline def findSourceMap(path: String): tmttyped.node.moduleMod.SourceMap = ^.asInstanceOf[js.Dynamic].applyDynamic("findSourceMap")(path.asInstanceOf[js.Any]).asInstanceOf[tmttyped.node.moduleMod.SourceMap]
  inline def findSourceMap(path: String, error: js.Error): tmttyped.node.moduleMod.SourceMap = (^.asInstanceOf[js.Dynamic].applyDynamic("findSourceMap")(path.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[tmttyped.node.moduleMod.SourceMap]
