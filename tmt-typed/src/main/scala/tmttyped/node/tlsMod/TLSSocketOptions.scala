...
trait TLSSocketOptions
  ...
  /**
    ...
    */
  var server: js.UndefOr[tmttyped.node.nodeNetMod.Server] = js.undefined
...
object TLSSocketOptions {
  ...
  extension [Self <: TLSSocketOptions](x: Self) {
    ...
    inline def setServer(value: tmttyped.node.nodeNetMod.Server): Self = StObject.set(x, "server", value.asInstanceOf[js.Any])
