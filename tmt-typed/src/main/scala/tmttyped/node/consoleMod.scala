...
import tmttyped.node.consoleMod.global.NodeJS.ConsoleConstructor
  ...
  object global {
    ...
    object NodeJS {
      ...
      trait ConsoleConstructorOptions extends StObject {
        ...
        var inspectOptions: js.UndefOr[tmttyped.node.NodeJS.InspectOptions] = js.undefined
      ...
      object ConsoleConstructorOptions {
        ...
        implicit class ConsoleConstructorOptionsMutableBuilder[Self <: ConsoleConstructorOptions] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setInspectOptions(value: tmttyped.node.NodeJS.InspectOptions): Self = StObject.set(x, "inspectOptions", value.asInstanceOf[js.Any])
