...
import tmttyped.node.anon.Abort
import tmttyped.node.anon.End
import tmttyped.node.anon.InstantiableAbortController
import tmttyped.node.anon.Paths
import tmttyped.node.anon.Transfer
import tmttyped.node.bufferMod.global.Buffer
import tmttyped.node.bufferMod.global.BufferEncoding
import tmttyped.node.eventsMod.global.NodeJS.EventEmitter
import tmttyped.node.globalsMod.NodeJS.CallSite
import tmttyped.node.globalsMod.NodeJS.Module
import tmttyped.node.globalsMod.NodeJS.Require
...
import tmttyped.std.EventTarget
...
object globalsMod {
  ...
  object AbortController {
    ...
    @js.native
    val ^ : InstantiableAbortController = js.native
  ...
  @js.native
  def AbortSignal: Abort = js.native
  inline def AbortSignal_=(x: Abort): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AbortSignal")(x.asInstanceOf[js.Any])
  ...
  *-----------------------------------------------*/
  object NodeJS {
    ...
    trait ReadWriteStream
      extends StObject
         with ReadableStream
         with tmttyped.node.globalsMod.NodeJS.WritableStream
    ...
    trait ReadableStream
      ...
      def pipe[T /* <: tmttyped.node.globalsMod.NodeJS.WritableStream */](destination: T): T = js.native
      def pipe[T /* <: tmttyped.node.globalsMod.NodeJS.WritableStream */](destination: T, options: End): T = js.native
      ...
      def unpipe(destination: tmttyped.node.globalsMod.NodeJS.WritableStream): this.type = js.native
    ...
    trait Require extends StObject {
      ...
      @JSName("resolve")
      var resolve_Original: tmttyped.node.globalsMod.NodeJS.RequireResolve = js.native
    }
  ...
  type RequireResolve = tmttyped.node.globalsMod.NodeJS.RequireResolve
