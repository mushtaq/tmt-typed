...
object rsocketbinaryframingMod {
  ...
  @scala.inline
  def sizeOfFrame(frame: Frame, encoders: Encoders[_]): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sizeOfFrame")(frame.asInstanceOf[js.Any], encoders.asInstanceOf[js.Any])).asInstanceOf[Double]
}
