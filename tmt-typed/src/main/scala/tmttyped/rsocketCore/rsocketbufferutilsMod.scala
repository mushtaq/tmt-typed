...
object rsocketbufferutilsMod {
  ...
  */
  ...
  object Encoding {
    ...
    inline def ascii: tmttyped.rsocketCore.rsocketCoreStrings.ascii = "ascii".asInstanceOf[tmttyped.rsocketCore.rsocketCoreStrings.ascii]
    
    inline def base64: tmttyped.rsocketCore.rsocketCoreStrings.base64 = "base64".asInstanceOf[tmttyped.rsocketCore.rsocketCoreStrings.base64]
    
    inline def hex: tmttyped.rsocketCore.rsocketCoreStrings.hex = "hex".asInstanceOf[tmttyped.rsocketCore.rsocketCoreStrings.hex]
    
    inline def utf8: tmttyped.rsocketCore.rsocketCoreStrings.utf8 = "utf8".asInstanceOf[tmttyped.rsocketCore.rsocketCoreStrings.utf8]
  }
}
